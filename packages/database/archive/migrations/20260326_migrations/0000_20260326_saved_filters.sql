...
CREATE UNIQUE INDEX "asf_unique_name" ON "activity_saved_filters" USING btree ("owner_user_id","context_key","name") WHERE is_active = true;--> statement-breakpoint
CREATE INDEX "asf_scope_team_id_idx" ON "activity_saved_filters" USING btree ("scope_team_id");