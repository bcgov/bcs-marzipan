 ...
 */
export const activityCommunicationMaterials = pgTable(
  'activity_communication_materials',
  {
 ...
 */
export const activityKeywords = pgTable(
  'activity_keywords',
  {
    activityId: integer('activity_id')
      .notNull()
...
export const activityCommunicationMaterialsRelations = relations(
...
export const activityInitiativesRelations = relations(
  activityInitiatives,
  ({ one }) => ({
    activity: one(activities, {
...
export const activityNROriginsRelations = relations(
  activityNROrigins,
  ({ one }) => ({
    activity: one(activities, {
...
export const activitySharedWithRelations = relations(
  activitySharedWith,
  ({ one }) => ({
    activity: one(activities, {
