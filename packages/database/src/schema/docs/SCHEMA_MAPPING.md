...
| `EventPlannerId`                    | `int`               | _Moved to activity_event_planners_      | -                          | -                                                       | Moved to junction table activity_event_planners. Each row has optional eventPlannerLeadId (FK to event_planners) or eventPlannerLeadName (free text). Multiple planners per activity. |
...
| -                                | `activityEventPlanners`        | New - replaces single eventPlannerLeadId/eventPlannerLeadName on activities. Allows multiple planners per activity; each row has optional eventPlannerLeadId (lookup) or eventPlannerLeadName (free text). |
