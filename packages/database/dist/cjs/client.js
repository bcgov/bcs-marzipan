...
exports.db = exports.migrationClient = exports.queryClient = void 0;
...
// For query purposes
exports.queryClient = connectionString ? postgres(connectionString) : null;
// For migrations
exports.migrationClient = connectionString
    ? postgres(connectionString, { max: 1 })
    : null;
exports.db = connectionString
    ? (0, postgres_js_1.drizzle)(exports.queryClient, { schema })
    : null;
