 ...
 */
import { pgTable, serial, timestamp, varchar, text, integer, boolean, uuid, bigint, } from 'drizzle-orm/pg-core';
import { relations } from 'drizzle-orm';
// Import table objects for relations
import { activityStatuses, cities, governmentRepresentatives, communicationContacts, eventPlanners,
// videographers,
 } from '../schema/lookups';
...
export const legacyActivitiesRelations = relations(legacyActivities, ({ one, many }) => ({
