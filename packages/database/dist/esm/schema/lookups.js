import { pgTable, serial, varchar, integer, boolean, text, timestamp, uuid, jsonb, } from 'drizzle-orm/pg-core';
...
export const governmentRepresentativesRelations = relations(governmentRepresentatives, ({ one }) => ({
