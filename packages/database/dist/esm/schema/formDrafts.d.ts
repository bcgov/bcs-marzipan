 ...
 */
export declare const formDrafts: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "form_drafts";
    schema: undefined;
    columns: {
 ...
 */
export declare const formDraftsRelations: import("drizzle-orm").Relations<"form_drafts", {
    user: import("drizzle-orm").One<"users", true>;
}>;
export type FormDraft = typeof formDrafts.$inferSelect;
export type NewFormDraft = typeof formDrafts.$inferInsert;
//# sourceMappingURL=formDrafts.d.ts.map