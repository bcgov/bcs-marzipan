 ...
 */
export declare const activityStatuses: import("drizzle-orm/pg-core").PgTableWithColumns<{
...
export declare const categories: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        allowsPitch: import("drizzle-orm/pg-core").PgColumn<{
            name: "allows_pitch";
            tableName: "categories";
            dataType: "boolean";
            columnType: "PgBoolean";
 ...
 */
export declare const dateStatuses: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "date_statuses";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "date_statuses";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 * Values: 'unknown', 'tentative', 'confirmed'
 */
export declare const timeStatuses: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "time_statuses";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "time_statuses";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 * Values: 'unknown', 'tentative', 'confirmed'
 */
export declare const venueStatuses: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "venue_statuses";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "venue_statuses";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 */
export declare const governmentRepresentatives: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "government_representatives";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "government_representatives";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
        ...
        representativeType: import("drizzle-orm/pg-core").PgColumn<{
 ...
 */
export declare const commsContacts: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "comms_contacts";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "comms_contacts";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 */
export declare const eventPlanners: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "event_planners";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "event_planners";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 */
export declare const themes: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "themes";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
        ...
        topReleaseId: import("drizzle-orm/pg-core").PgColumn<{
            name: "top_release_id";
            tableName: "themes";
            dataType: "string";
            columnType: "PgUUID";
        ...
        featureReleaseId: import("drizzle-orm/pg-core").PgColumn<{
 ...
 */
export declare const pitchStatuses: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "pitch_statuses";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "pitch_statuses";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 */
export declare const commsMaterials: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "comms_materials";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "comms_materials";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 */
export declare const translatedLanguages: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "translated_languages";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "translated_languages";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 */
export declare const newsReleaseOrigins: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "news_release_origins";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "news_release_origins";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 */
export declare const newsReleaseDistributions: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "news_release_distributions";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "news_release_distributions";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 */
export declare const premierRequested: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "premier_requested";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "premier_requested";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
 ...
 */
export declare const activityFilters: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "activity_filters";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "activity_filters";
            dataType: "number";
            columnType: "PgSerial";
            data: number;
            driverParam: number;
        ...
        queryString: import("drizzle-orm/pg-core").PgColumn<{
            name: "query_string";
            tableName: "activity_filters";
            dataType: "string";
            columnType: "PgVarchar";
...
export declare const governmentRepresentativesRelations: import("drizzle-orm").Relations<"government_representatives", {
...
export declare const categoriesRelations: import("drizzle-orm").Relations<"categories", {
    teamCategories: import("drizzle-orm").Many<"team_categories">;
}>;
