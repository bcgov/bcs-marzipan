...
CREATE TABLE "activity_flags" (
	...
	"display_team_id" integer,
	"note" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "activity_flags_activity_id_team_id_assignee_id_unique" UNIQUE("activity_id","team_id","assignee_id")
);
--> statement-breakpoint
...
ALTER TABLE "activity_flags" ADD CONSTRAINT "activity_flags_display_team_id_teams_id_fk" FOREIGN KEY ("display_team_id") REFERENCES "public"."teams"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "activity_flags_activity_id_team_id_idx" ON "activity_flags" USING btree ("activity_id","team_id");--> statement-breakpoint
CREATE INDEX "activity_flags_display_team_id_idx" ON "activity_flags" USING btree ("display_team_id");--> statement-breakpoint
