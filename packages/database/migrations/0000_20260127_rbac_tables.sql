...
CREATE TABLE "categories" (
	...
	"display_name" varchar(255) NOT NULL,
	"sort_order" integer DEFAULT 0 NOT NULL,
	"allows_pitch" boolean DEFAULT true NOT NULL,
	"visibility" varchar(50) DEFAULT 'global' NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
	"description" text,
	"created_date_time" timestamp with time zone DEFAULT now() NOT NULL,
...
ALTER TABLE "venues" ADD CONSTRAINT "venues_last_updated_by_users_id_fk" FOREIGN KEY ("last_updated_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
