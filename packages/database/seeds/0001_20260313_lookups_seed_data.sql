...
INSERT INTO reports (id, name, display_name, sort_order, is_active, visibility, config, description, created_by, last_updated_by) VALUES
  ...
  (
    ...
    true,
    'team',
    '{"fields": ["startDate", "endDate", "startTime", "displayId", "title", "isConfidential", "summary", "category", "isIssue", "newsReleaseOrigin", "strategy", "commsContact", "lastUpdatedDateTime"], "printTemplate": "thirtySixtyNinetyV1", "globalFilter": {"dateRange": {"start": "2025-01-01", "end": "2025-06-30"}}, "sections": [{"id": "thirty", "name": "30 Days", "order": 1, "filter": {"dateRange": {"start": "2025-01-01", "end": "2025-01-31"}}}, {"id": "sixty", "name": "60 Days", "order": 2, "filter": {"dateRange": {"start": "2025-02-01", "end": "2025-03-02"}}}, {"id": "ninety", "name": "90 Days", "order": 3, "filter": {"dateRange": {"start": "2025-03-03", "end": "2025-06-30"}}}]}'::jsonb,
  ...
  (
    ...
    true,
    'team',
    '{"fields": ["startDate", "endDate", "startTime", "displayId", "title", "isConfidential", "summary", "category", "isIssue", "newsReleaseOrigin", "lookAheadStatus", "lookAheadSection"], "printTemplate": "lookAheadV1", "sections": [{"id": "events", "name": "Events", "uiDisplayName": "Events", "reportDisplayName": "Events, speeches and releases (inside government)", "legendColor": "#2C7DA0", "order": 1, "filter": {"lookAheadSection": "events"}}, {"id": "issues", "name": "Issues", "uiDisplayName": "Issues", "reportDisplayName": "Issues and reports", "legendColor": "#C1121F", "order": 2, "filter": {"lookAheadSection": "issues"}}]}'::jsonb,
