...
INSERT INTO reports (id, name, display_name, sort_order, is_active, visibility, config, description, created_by, last_updated_by) VALUES
  ...
  (
    ...
    true,
    'team',
    '{"fields": ["startDate", "endDate", "startTime", "displayId", "title", "isConfidential", "summary", "category", "isIssue", "newsReleaseOrigin", "strategy", "commsContact", "lastUpdatedDateTime"], "sections": [{"id": "thirty", "name": "30 Days", "order": 1}, {"id": "sixty", "name": "60 Days", "order": 2}, {"id": "ninety", "name": "90 Days", "order": 3}]}'::jsonb,
  ...
  (
    ...
    true,
    'team',
    '{"fields": ["startDate", "endDate", "startTime", "displayId", "title", "isConfidential", "executiveSummary", "summary", "category", "isIssue", "newsReleaseOrigin", "activityStatus"], "sections": [{"id": "new", "name": "New Activities", "order": 1}, {"id": "in-progress", "name": "In Progress", "order": 2}, {"id": "completed", "name": "Completed", "order": 3}, {"id": "cancelled", "name": "Cancelled", "order": 4}]}'::jsonb,
    'Activity Status report grouping activities by their current status',
    1,
    1
  ),
  (
    ...
    true,
    'team',
    '{"fields": ["startDate", "endDate", "startTime", "displayId", "title", "isConfidential", "executiveSummary", "summary", "category", "isIssue", "newsReleaseOrigin", "tags"], "sections": [{"id": "all", "name": "All Activities", "order": 1}]}'::jsonb,
    'Tag/Keyword report for filtering activities by tags or keywords',
    1,
    1
  ),
  (
    ...
    true,
    'team',
    '{"fields": ["startDate", "endDate", "startTime", "displayId", "title", "isConfidential", "executiveSummary", "summary", "category", "isIssue", "newsReleaseOrigin"], "sections": [{"id": "all", "name": "All Activities", "order": 1}]}'::jsonb,
    'Date Range report for custom date filtering',
    1,
    1
  )
ON CONFLICT (id) DO NOTHING;
