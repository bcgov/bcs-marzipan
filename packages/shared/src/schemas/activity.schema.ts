 ...
 *
 * Note: The type assertion `z.ZodTypeAny & typeof activitySchema` is used because
 * drizzle-zod's BuildSchema type is compatible with Zod but TypeScript's type system
 * needs help recognizing the compatibility. This is a known limitation of the drizzle-zod
 * library's type definitions.
 *
 * @see https://github.com/drizzle-team/drizzle-zod for more information
 */
