...
const activityCoreFieldsSchema = z.object({
  ...
  dateStatusId: z.number().int().optional(), // Optional: server applies defaults when user lacks dateTimeStatus edit
  timeStatusId: z.number().int().optional(), // Optional: server applies defaults when user lacks dateTimeStatus edit
