...
.custom-report-col-date { width: 13%; }
.custom-report-col-lead { width: 13%; }
.custom-report-col-details { width: 56%; }
.custom-report-col-release { width: 10%; }
.custom-report-col-id { width: 8%; }
.custom-report-td {
  padding: 0.75rem 1rem;
