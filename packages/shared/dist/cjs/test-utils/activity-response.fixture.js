...
exports.createMockActivityResponse = createMockActivityResponse;
 ...
 * });
 */
function createMockActivityResponse(overrides) {
    return {
        // Primary key
        id: 1,
        ...
        visibility: constants_1.DEFAULT_VISIBILITY,
        // Ownership
        ...
        dateStatus: 'Set',
        timeStatus: 'Set',
        activityStatus: constants_1.DEFAULT_ACTIVITY_STATUS,
