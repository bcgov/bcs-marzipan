...
import type { AttendingStatus, LookAheadStatus, LookAheadSection, CalendarVisibility } from '../constants/activity-enums';
/**
 * ActivityResponseDto
 *
 ...
 */
export declare class ActivityResponseDto implements ActivityResponse {
    id: number;
...
//# sourceMappingURL=activity-response.dto.d.ts.map