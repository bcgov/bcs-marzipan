 ...
 */
export const VISIBILITY = ['global', 'team'];
// ============================================================================
 ...
 */
export const LOOK_AHEAD_STATUS = ['none', 'new', 'changed'];
/**
 ...
 */
export const CALENDAR_VISIBILITY = ['visible', 'partial', 'hidden'];
/**
 ...
 */
export const DEFAULT_ACTIVITY_STATUS = 'new';
// ============================================================================
 ...
 */
export const DEFAULT_LOOK_AHEAD_STATUS = 'none';
/**
 * Default look ahead section
 */
export const DEFAULT_LOOK_AHEAD_SECTION = 'events';
/**
 * Default visibility level
 */
export const DEFAULT_VISIBILITY = 'global';
