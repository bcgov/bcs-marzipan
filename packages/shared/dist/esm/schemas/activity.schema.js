import { z } from 'zod';
import { LOOK_AHEAD_STATUS, LOOK_AHEAD_SECTION, VISIBILITY, } from '../constants/constants';
/**
...
const activityCoreFieldsSchema = z.object({
    ...
    leadOrgId: z.preprocess(emptyStringToNull, z.string().uuid().nullable().optional()),
    leadOrgName: z.string().max(255).nullable().optional(),
    newsReleaseId: z.preprocess(emptyStringToNull, z.string().uuid().nullable().optional()),
 ...
 */
const reportSettingSchema = z.preprocess((val) => {
