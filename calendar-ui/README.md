...
- **[Activity form field updates](docs/ACTIVITY_FORM_FIELD_UPDATES.md)** — Use `setActivityFormFieldValue` for custom controls in activity form sections (RHF / React 19).
